...
async function seedDatabase() {
    try {
        ...
        const services = [
            {
                name: "Haircut",
                description: "Custom style with the latest trends.",
                price: 60.0,
                imageUrl: "https://utfs.io/f/0ddfbd26-a424-43a0-aaf3-c3f1dc6be6d1-1kgxo7.png",
            },
            {
                name: "Beard",
                description: "Complete shaping to highlight your masculinity.",
                price: 40.0,
                imageUrl: "https://utfs.io/f/e6bdffb6-24a9-455b-aba3-903c2c2b5bde-1jo6tu.png",
            },
            {
                name: "Foot Grooming",
                description: "Perfect finish for a renewed look.",
                price: 35.0,
        ...
        console.error(
            "Error creating barbershops:", error);
    }
}
